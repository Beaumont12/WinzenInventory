  ...
  return (
    ...
    <div className="p-4">
      ...
      <div className="flex justify-center items-center h-screen mt-10 mb-10">
        <div className="max-w-md mx-auto bg-white border border-gray-300 p-8 rounded-lg shadow-lg">
          ...
          {showConfirmation && (
            <div className="fixed z-10 inset-0 overflow-y-auto">
              <div className="flex items-center justify-center min-h-screen">
                ...
                <div className="relative bg-white rounded-lg overflow-hidden max-w-md w-full">
                  <div className="p-6">
                    <h2 className="text-xl font-semibold mb-4">User Added Successfully</h2>
                      <p className="text-gray-700">The user has been successfully added to the database.</p>
                      <div className="mt-4 flex justify-end">
